...
SPHERE_DEFAULTS = {
    "production": {
        ...
        "opex_pct": 20,
        "total_capex": 0.08,
        "capex_pct_schedule": [15, 35, 35, 15],
    ...
    "toll-road": {
        ...
        "opex_pct": 7.79,
        "total_capex": 238963,
        "capex_pct_schedule": [19.93, 38.92, 30.5, 10.65],
        ...
        "initial_cash": 0.01,
        "initial_investment": 0,
        "avg_daily_traffic": 74654,
        "tariff_rub_per_km": 65.05,
        "road_length_km": 16.2,
    ...
    "agriculture": {
        ...
        "opex_pct": 15,
        "total_capex": 0.12,
        "capex_pct_schedule": [20, 30, 30, 20],
                    ...
                    dbc.Col([
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                ...
                                {"label": "Cash Sweep", "value": "Sweep"},
                            ],
                            value=DEFAULTS["repayment_type"],
                            clearable=False,
                        ),
                    ], md=6, className="mb-3"),
                    input_group("Cash Sweep %", "inp-sweep-pct",
                                DEFAULTS.get("sweep_pct", 100), suffix="%", step=5),
                ]),
...
def update_sphere_inputs(sphere):
    ...
    return (
        ...
        d["initial_cash"],
        d.get("avg_daily_traffic", 74654),
        d.get("tariff_rub_per_km", 65.05),
...
def run_model(n_clicks, *args):
    keys = [
        ...
        "initial_debt", "interest_rate", "repayment_type", "new_debt_annual", "sweep_pct",
